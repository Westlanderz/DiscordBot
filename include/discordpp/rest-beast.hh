...
template <class BASE>
class RestBeast : public BASE,
                  virtual public BotStruct,
                  public std::enable_shared_from_this<RestBeast<BASE>> {
  ...
  private:
    ...
    void on_resolve(beast::error_code ec, tcp::resolver::results_type results,
        ...
        beast::get_lowest_layer(session->stream)
    ...
    void on_read(beast::error_code ec, std::size_t bytes_transferred,
        ...
        for (auto h : {"X-RateLimit-Global", "X-RateLimit-Limit",
        ...
        session->stream.async_shutdown(
            std::bind(beast::bind_front_handler(&RestBeast::on_shutdown,
                                                this->shared_from_this()),
