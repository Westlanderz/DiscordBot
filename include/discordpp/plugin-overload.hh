...
template <class BASE> class PluginOverload : public BASE, virtual BotStruct {
  public:
    ...
    virtual void call(const std::string &requestType,
                      const std::string &targetURL) {
        BASE::call(std::make_shared<Call>(
            Call{std::make_shared<std::string>(requestType),
                 std::make_shared<std::string>(targetURL), nullptr, nullptr,
                 nullptr}));
    };
    ...
    virtual void call(const std::string &requestType,
        ...
        BASE::call(std::make_shared<Call>(
            Call{std::make_shared<std::string>(requestType),
                 ...
                 std::make_shared<json>(body), nullptr, nullptr}));
    };
    ...
    virtual void call(const std::string &requestType,
        ...
        BASE::call(std::make_shared<Call>(
            Call{std::make_shared<std::string>(requestType),
                 std::make_shared<std::string>(targetURL), nullptr,
                 std::make_shared<handleWrite>(onWrite), nullptr}));
    };

    virtual void call(const std::string &requestType,
                      const std::string &targetURL, const handleRead &onRead) {
        BASE::call(std::make_shared<Call>(
            Call{std::make_shared<std::string>(requestType),
                 std::make_shared<std::string>(targetURL), nullptr, nullptr,
    ...
    virtual void call(const std::string &requestType,
        ...
        BASE::call(std::make_shared<Call>(
            Call{std::make_shared<std::string>(requestType),
                 std::make_shared<std::string>(targetURL),
                 std::make_shared<json>(body), nullptr,
                 std::make_shared<handleRead>(onRead)}));
    };

    virtual void call(const std::string &requestType,
                      const std::string &targetURL, const json &body,
                      const handleWrite &onWrite, const handleRead &onRead) {
        BASE::call(std::make_shared<Call>(
            Call{std::make_shared<std::string>(requestType),
                 std::make_shared<std::string>(targetURL),
                 std::make_shared<json>(body),
